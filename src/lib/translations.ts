...
export const translations = {
    tr: {
        ...
        categories: {
            ...
            'Hayvanlar': 'Hayvanlar',
            'Ülkeler': 'Ülkeler',
            'Yerli Diziler': 'Yerli Diziler',
            'Yabancı Diziler': 'Yabancı Diziler',
            'Yerli Filmler': 'Yerli Filmler',
            'Yabancı Filmler': 'Yabancı Filmler',
            'Anime & Çizgi Dizi': 'Anime & Çizgi Dizi',
    ...
    en: {
        ...
        categories: {
            ...
            'Hayvanlar': 'Animals',
            '\u00dclkeler': 'Countries',
            'Yerli Diziler': 'Turkish TV Shows',
            'Yabanc\u0131 Diziler': 'Foreign TV Shows',
            'Yerli Filmler': 'Turkish Movies',
            'Yabanc\u0131 Filmler': 'Foreign Movies',
            'Anime & \u00c7izgi Dizi': 'Anime & Cartoons',
        } as Record<string, string>,
        shareText: 'Share',
